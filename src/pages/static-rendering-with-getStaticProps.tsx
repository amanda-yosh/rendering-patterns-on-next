...
export default function StaticRenderingWithGetStaticProps({ user }: InferGetStaticPropsType<typeof getStaticProps>) {
    return (
        <>
            <Head>
                <title>Renderização Estática com getStaticProps | Static Rendering with getStaticProps</title>
            ...
            <div className={pagesStyles.page}>
                <main className={pagesStyles.main}>
                    ...
                    <section className={pagesStyles.section}>
                        ...
                        <p>
                            Assim, podemos evitar fazer fetchs de dados no cliente e o uso do componente Skeleton enquanto os dados são carregados, pois a página já é renderizada com os dados.
                        </p>

                        <p>
                            Como o <span className={styles.focus}>getStaticProps roda somente no lado do servidor</span>, ele nunca rodará no lado do cliente, e <span className={styles.focus}>não será incluído no bundle JS para o navegador</span>, então você pode escrever consultas diretas ao banco de dados sem que elas sejam enviadas aos navegadores. Isso significa que, em vez de buscar uma rota de API no getStaticProps, você pode escrever o código do lado do servidor diretamente no método.
                        </p>

                        <p>
                            Quando ocorre o build, além do arquivo HTML da página, <span className={styles.focus}>o Next.js gera um arquivo JSON contendo o resultado da execução do getStaticProps</span>. Este arquivo é usado no roteamento do lado do cliente por meio de next/link ou next/router.
                        </p>

                        <p>
                            Quando você navega para uma página que é pré-renderizada usando getStaticProps, o Next.js busca este arquivo JSON e o usa como props para o componente da página. <span className={styles.focus}>Isso significa que as transições de página do lado do cliente não chamarão o getStaticProps</span>, pois apenas o JSON exportado é usado.
                        </p>
                    </section>
                    ...
                    <section className={pagesStyles.section}>
                        <VideoWrapper fileName='video3.webm' source="https://www.patterns.dev/vanilla/rendering-patterns" />

                        <p>
                            Quando construímos o projeto, o provedor de dados é chamado e os dados retornados são canalizados para o HTML gerado.
                        </p>

                        <VideoWrapper fileName='video4.webm' source="https://www.patterns.dev/vanilla/rendering-patterns" />
                    ...
                    <ImageWrapper image={img1} source="https://www.patterns.dev/vanilla/rendering-patterns" />
