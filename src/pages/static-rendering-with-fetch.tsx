...
export default function StaticRenderingWithFetch() {
    ...
    return (
        <>
            <Head>
                <title>Renderização Estática com Fetch | Static Rendering with Fetch</title>
            ...
            <div className={pagesStyles.page}>
                <main className={pagesStyles.main}>
                    ...
                    <section className={pagesStyles.section}>
                        <p>
                            Acima, você viu um exemplo de uma lista de Doguinhos. Para criar essa listagem foi preciso uma API, criada com o <Link href='https://nextjs.org/docs/pages/building-your-application/routing/api-routes' style={{ textDecoration: 'underline' }}>API Routes,</Link> que nos forneceu os dados necessários.
                        </p>
                    ...
                    <section className={pagesStyles.section}>
                        ...
                        <VideoWrapper fileName='video2.webm' source="https://www.patterns.dev/vanilla/rendering-patterns" />

                        <p>
                            O arquivo HTML pré-gerado é enviado ao cliente quando o usuário solicita a página. O usuário inicialmente vê a UI do esqueleto sem nenhum dado. O cliente busca os dados com um request para a API, recebe a resposta e mostra a listagem.
                        </p>
                    </section>
                    ...
                    <section className={pagesStyles.section}>
                        <p>
                            ...
                            <br />
                            Existem outras soluções utilizando o Next.js, que vamos ver mais a frente, para melhorar o desempenho da aplicação ao trabalhar com dados dinâmicos.
                        </p>
                    </section>
                </main>
            </div>
